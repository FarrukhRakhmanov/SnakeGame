...
namespace SnakeGame.Components.Screens
{
    public class AboutScreen : GameScreen
    {
        ...
        public override void LoadContent(ContentManager content)
        {
            ...
            //_menu.AddMenuItem(new MenuItem("Back to Main menu", new Rectangle(100, 100, 400, 50), BackToMainMenu, Color.White, Color.Orange));
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(_font, "Developed by: Valentine Ohalebo", new Vector2(100, 250), Color.White);
            spriteBatch.End();
        }
